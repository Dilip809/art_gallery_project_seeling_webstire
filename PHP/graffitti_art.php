...
<head>
    ...
    <link rel="stylesheet" href="../CSS/graffitti_art.css">
</head>
<body>
    ...
    <div class="heading">
        ...
        <a href="mycart.php"><i class="fa fa-shopping-cart" style="font-size:36px; color: white;"></i></a>
    </div>
                ...
                <div class="box">
                    ...
                    <div class="form">
                        <form action="graffitti_art.php" method="post">
                            <input type="hidden" name="img" value="<?php echo $row['image']; ?>" required>
                            <input type="hidden" name="category" value="<?php echo $row['category']; ?>" required>
                            <input type="hidden" name="price" value="<?php echo $row['prize']; ?>" required>
                            <input type="hidden" name="name" value="<?php echo $row['ArtName']; ?>" required>
                            <input type="hidden" name="detail" value="<?php echo $row['detail']; ?>" required>
                            <input type="hidden" name="size" value="<?php echo $row['size']; ?>" required>
                            <input type="hidden" name="id_no" value="<?php echo $row['id']; ?>" required>
